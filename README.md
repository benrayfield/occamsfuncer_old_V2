...
occamsfuncer version 1 and 2 used a different universal lambda function than version 3 (2020-8), which has reached its final form other than the first of 15 parameters is there for possible future expansion and by default is always the universal function (leaf) itself. The newest version is at https://github.com/benrayfield/occamsfuncer and hopefully there will be many compatible implementations of this universal function that work together in realtime across the Internet.
